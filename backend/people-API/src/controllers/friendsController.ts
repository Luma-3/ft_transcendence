...
export async function addFriend(req: FastifyRequest, res: FastifyReply) {
...
export async function removeFriend(req: FastifyRequest, res: FastifyReply) {
	const userId = req.headers['x-user-id'];
	const { friendId } = req.params;
...
export async function refuseFriend(req: FastifyRequest, res: FastifyReply) {
	const userId = req.headers['x-user-id'];
	const { friendId } = req.params;
