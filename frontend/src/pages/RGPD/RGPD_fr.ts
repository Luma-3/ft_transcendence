...
export default function RGPD_FR() {
  return `
  ...
  <ul class="list-disc list-inside mb-4 space-y-1">
    ...
    <li><strong>Google ID</strong> : identifiant unique de votre compte Google, utilisé pour l'authentification.</li>
  ...
  <p class="mb-4">
    ...
    <a href="mailto:contact@theduckscompany.com" class="text-dsecondary hover:underline">contact@theduckscompany.com</a>. Pour plus d’informations, consultez le site de la CNIL :
  ...
  <p class="mb-4">
    ...
    auprès de la CNIL : <a href="https://www.cnil.fr" class="text-dsecondary hover:underline" target="_blank">cnil.fr</a>.
  </p>
