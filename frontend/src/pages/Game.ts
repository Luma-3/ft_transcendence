...
for (const player of allPlayer) {
	...
	return `
	<div id=${player.playerId} class="flex flex-col w-1/2 h-1/2 p-4 justify-center items-center transition-transform duration-800 ease-in-out">
