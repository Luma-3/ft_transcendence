		...
		bg-myblack from-primary to-secondary">
			...
			<div class="flex flex-row justify-between items-center space-x-4 mt-4">
				...
				<div class="flex justify-end-safe space-x-2 items-center">
					<div id="accept-invitation-game-notif" data-id="${invitation.id}" data-username="${userInfo.username}" 
					...
					<div id="refuse-invitation-game-notif" data-id="${invitation.id}" data-username="${userInfo.username}" class="hover:cursor-pointer group/item relative ">
