export function homeButton() {
	return `
		<div class="flex justify-center">
			<button class="font-title h-auto w-[170px] mt-2 group p-5 cursor-pointer relative text-2xl
			...
			<span id="loadLogin" class="group-hover:w-full absolute left-0 h-full w-5 border-y-4 border-l-4
