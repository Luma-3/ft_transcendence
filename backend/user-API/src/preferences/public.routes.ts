...
import { PREFERENCES_PRIVATE_COLUMNS, PREFERENCES_PUBLIC_COLUMNS } from './model.js';

import { PreferencesGetType, PreferencesPublicResponse } from './schema.js';
...
import { updateAvatarPreferences, updateBannerPreferences } from './controller.js';
