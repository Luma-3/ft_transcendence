...
export class Room {
  ...
  public gameLoop: LoopManager = new LoopManager(60);
  public netLoop: LoopManager = new LoopManager(25);
  private readonly pong: Pong = new Pong(this.gameLoop); // TODO : Go to FACTORY Sys
  ...
  constructor(gameInfos: IGameInfos) {
    ...
    this.gameLoop.addObject(this.pong);
    this.netLoop.addObject(this.pong);
  }
