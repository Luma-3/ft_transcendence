...
function UserMenuOptions() {
	return `<ul class="py-1 text-tertiary dark:text-dtertiary" aria-labelledby="menu-dropdown">
				<li>
					<a href="/profile" class="flex items-center py-2 px-2 text-sm font-title hover:bg-primary dark:hover:bg-myblack dark:hover:text-dtertiary">
				...
				<li>
					<a href="#" class="flex items-center py-2 px-2 text-sm font-title hover:bg-primary dark:hover:bg-myblack dark:hover:text-dtertiary">
				...
				<li>
					<a href="/settings" class="flex items-center py-2 px-2 text-sm font-title hover:bg-primary dark:hover:bg-myblack dark:hover:text-dtertiary">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2">
...
function logout() {
	return `<div id="logout" translate="logout" 
