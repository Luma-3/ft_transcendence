...
export function homeButton() {
	return `
		<div class="flex justify-center">
			...
			<span class="group-hover:w-full absolute left-0 h-full w-5 border-y-4 border-l-4 dark:border-dprimary border-primary
			...
			<span id="loadLogin" class="group-hover:translate-x-0 group-hover:opacity-100 absolute translate-x-full
			...
			<span id="loadLogin"  class="group-hover:w-1/2 absolute right-0 h-full w-5 
				border-y-4 border-r-4 border-secondary transition-all duration-500"> </span>
		  </button>
		</div>`;
